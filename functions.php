...
function insurance_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'insurance' ),
	) );
...
function insurance_scripts() {
	...
	// script added
	wp_enqueue_script( 'insurance-scripts', get_template_directory_uri() . '/js/scripts.js', array('jquery') );

	wp_enqueue_style( 'insurance-style', get_stylesheet_uri() );

	wp_enqueue_script( 'insurance-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'insurance-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
